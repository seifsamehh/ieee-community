...
import './style/media-ar.css'

const MediaAr = () => {
  return (
    <main className='media-ar'>
      <Helmet>
        <title>وسائل الاعلام</title>
      </Helmet>
        <HeaderAr/>
        {/* start intro */}
        <section className="intro-ar h-screen flex justify-center items-center overflow-hidden">
            <div className="heading-box">
                <h1 className='web text-center text-9xl font-thin animate__animated animate__backInDown'>وسائل</h1>
                <h1 className='dev text-center text-9xl animate__animated animate__backInUp animate__delay-1s'>الاعلام</h1>
            </div>
        </section>
        {/* end intro */}
        {/* start about */}
        <section className="about-ar h-screen flex justify-center items-center flex-col gap-12">
            <AnimationOnScroll animateIn="animate__fadeInRight" animateOut="animate__fadeOutLeft">
                <h1 className='text-center text-7xl'>ما هى وسائل الاعلام؟</h1>
            </AnimationOnScroll>
            <p className='text-center'>لجنة الإعلام الرقمي. تقع على عاتقنا مسؤولية التحكم في عمل وسائل الإعلام<br/> والهيئات العامة المرتبطة بها ، بما في ذلك التصميمات وتحرير مقاطع الفيديو للمجتمع</p>
        </section>
        {/* end about */}
        {/* start team */}
